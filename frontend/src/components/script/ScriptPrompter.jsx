...
export default function ScriptPrompter() {
  ...
  if (scriptStep === '__done__') return (
    <div>
      <div style={s.ct}>Call script — complete</div>
      <div style={s.done}>Script complete. Select an outcome and save the form.</div>
    </div>
  )

  return (
    <div>
      <div style={s.ct}>Solar script — step {stepHistory.length} / {totalSteps}</div>
      <div style={s.prog}>
